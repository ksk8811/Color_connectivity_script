...
if strcmp(Whiskers,'box')
    ...
    yCI=ySem*tinv(1-0.025, length(yValues)-1);
    %plot the standard deviation box
    rectangle('Position',[i-Width/WhiskersWidthRatio,yMean-yStd,2*Width/WhiskersWidthRatio,2*yStd ],'FaceColor',StdColor(StdIndex,:),'EdgeColor', 'black','LineWidth',1);%'FaceColor',StdColor(StdIndex,:)
    %plot the mean+-SEM box
    rectangle('Position',[i-Width/WhiskersWidthRatio,yMean-yCI,2*Width/WhiskersWidthRatio,2*yCI ],'FaceColor',SEMColor(SEMIndex,:),'EdgeColor', 'black','LineWidth',1);%'FaceColor',SEMColor(SEMIndex,:)
    %plot the mean line 
