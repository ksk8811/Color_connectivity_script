...
parameters.fonc_dir_wc='_5iso$';
parameters.fonc_dir_oposit_phase = '_blip';
parameters.anat_dir_wc='S05_anatomy_T1_1mm';

%for the preprocessing : Volume selection
parameters.anatwc  = '^s.*\.nii.gz$'; %le nom generique du volume pour l'anat
parameters.funcwc  = '^f.*\.nii.gz$'; %le nom generique du volume pour les fonctionel
