...
%   A with zeros if necessary. FUN can be an inline function, a
%   text string containing the name of a function, or a string
%   containing an expression. FUN should operate on an M-by-N
%   block, X, and return a matrix, vector, or scalar Y:
%
%        Y = FUN(X)
%
...
%
%   B = BLKPROC(A,'indexed',...) processes A as an indexed image,
...
%   Example
%   -------
%   This example uses BLKPROC to set the pixels in each 8-by-8
%   block to the standard deviation of the elements in that
%   block.
%   
