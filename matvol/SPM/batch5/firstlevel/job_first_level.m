function matlabbatch = job_first_level(stat_dir,scans,regress,TR)

%-----------------------------------------------------------------------
% Job configuration created by cfg_util (rev $Rev: 4252 $)
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.fmri_spec.dir = stat_dir;
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'first user regressor';
