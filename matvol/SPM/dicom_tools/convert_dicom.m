function convert_dicom(P,spm_dir,par)
...
for nbdir = 1:length(P)
    ...
    ser = convert_dicom_without_tri(spm_dir,hdr_dic,unique_serie_index,ExamDescription,PatientName,SeriesDescription,USI,par);
